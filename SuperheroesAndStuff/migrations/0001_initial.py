    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant', models.CharField(default=b'', max_length=45)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            name='distributor',
            fields=[
                ('fullName', models.CharField(max_length=45, serialize=False, primary_key=True)),
                ('variant', models.CharField(default=b'', max_length=45)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mName', models.ForeignKey(to='SuperheroesAndStuff.distributesMedium', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='distName',
            field=models.ForeignKey(to='SuperheroesAndStuff.distributor', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='book',
            name='mName',
            field=models.ForeignKey(to='SuperheroesAndStuff.distributesMedium', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
