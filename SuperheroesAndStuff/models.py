...
#     comicAge = models.CharField(max_length=45, primary_key=True)
...
creator = Table('creator', metadata,
                ...
                Column('type', String(45), primary_key=True)
                )
...
distributesMedium = Table('distributesMedium', metadata,
                          ...
                          Column('distName', String(45), ForeignKey('distributor.name',
...
creates = Table('creates', metadata,
                ...
                ForeignKeyConstraint(['charName', 'charComicAge'], ['kharacter.name', 'kharacter.comicAge'],
                                     onupdate="CASCADE", ondelete="CASCADE"),
                ForeignKeyConstraint(['crName', 'crType'], ['creator.name', 'creator.type'],
                                     onupdate="CASCADE", ondelete="CASCADE")
                )
...
appearsIn = Table('appearsIn', metadata,
                  ...
                  ForeignKeyConstraint(['charName', 'comicAge'], ['kharacter.name', 'kharacter.comicAge'],
                                       onupdate="CASCADE", ondelete="CASCADE")
                  )